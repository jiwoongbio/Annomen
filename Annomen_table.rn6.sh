...
# - output file: rn6_refGene.gtf.gz
# - file type returned: gzip compressed
# - get output

if [ ! -f "rn6_refGene.gtf.gz" ]; then
	echo "rn6_refGene.gtf.gz is not available." >&2
	exit 1
fi
...
perl refGene.gtf.pl rn6_refGene.gtf.gz gene_info.gz gene2refseq.gz 10116 > rn6_refGene.gtf
...
perl Annomen_table.pl rn6_refGene.gtf rn6.fasta rat.rna.fna rat.protein.faa rat.rna.gbff > Annomen_table.rn6.txt 2> Annomen_table.rn6.log
